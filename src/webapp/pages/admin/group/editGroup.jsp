							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade active show" id="general"
									...
									<div class="col-md-6">
										...
										<div class="mb-3">
											<label for="site-title" class="form-label">Number of
												members</label> <input type="text" name="site_title"
												class="form-control" disabled value="${group.currentNumber}">
										</div>
										<div class="mb-3">
											<label for="site-title" class="form-label">Topic</label> <input
												type="text" name="site_title" class="form-control" disabled
												value="${group.topic.topicName}">
										</div>
										...
										<div class="mb-3 d-flex justify-content-between">
											<a href="<%=context%>/admin/groups" class="btn btn-success"
								...
								<div class="tab-pane fade" id="system" role="tabpanel"
									...
									<div class="col-md-6">
										...
										<c:forEach begin="1" end="2" var="item">
											<div class="mb-3">
												<label for="site-description" class="form-label">Member
													${item} </label> <select name="timezone" class="form-select">
